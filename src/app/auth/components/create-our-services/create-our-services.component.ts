...
import {OurServicesAction} from "../../store/Actions/actionsOurServices";

@Component({
  selector: 'app-create-our-services',
  templateUrl: './create-our-services.component.html',
  styleUrls: ['./create-our-services.component.css']
})
export class CreateOurServicesomponent implements OnInit {
  ...
  submit()
  {
    ...
    this.store.dispatch(OurServicesAction({request}))
